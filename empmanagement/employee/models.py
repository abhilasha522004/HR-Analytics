...
class Attendance(models.Model):
    ...
    type = models.CharField(max_length=10, choices=[('Office', 'Office'), ('Remote', 'Remote')])
    month = models.CharField(max_length=50,choices=months, blank=True, null=True)
    days = models.CharField(max_length=5,choices=days, blank=True, null=True)
    def __str__(self):
        return f"{self.eId} - {self.date} - {self.type}"
